          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-br from-[#833AB4] via-[#E1306C] to-[#F77737] rounded-full flex items-center justify-center hover:opacity-90 transition-opacity"
              >
